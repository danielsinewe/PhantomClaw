...
if __package__ in {None, ""}:
    ...
    from automation_analytics import trustoutreach_metrics, upsert_automation_run
    from trustoutreach_linkedin.browser_use_client import BrowserUseClient
    from trustoutreach_linkedin.config import RunnerConfig, parse_config
    from trustoutreach_linkedin.models import AgencyFeedSnapshot, AgencySnapshot, FeedSnapshot, PostSnapshot, RunReport, utc_now
...
def finalize(
    ...
    *,
    ...
    artifact_dir = artifact_dir or Path("artifacts/trustoutreach-linkedin")
