...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Upsert a daily north-star metric snapshot")
    ...
    with psycopg.connect(args.database_url) as conn:
        with conn.cursor() as cur:
            ...
            cur.execute(
                ...
                ON CONFLICT (workspace_slug, platform, profile_name, metric_name, metric_date) DO UPDATE SET
